  ...
  return (
    <div className="flex flex-col min-h-[100vh] items-center justify-center space-y-4 text-center">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Lost in the Clouds</h1>
        <p className="p-2 max-w-[600px] mx-auto text-gray-500 md:text-xl/relaxed dark:text-gray-400">
